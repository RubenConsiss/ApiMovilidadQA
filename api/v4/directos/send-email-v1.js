...
exports.send_email = async (req, res, next) => {
  ...
  try {
    ...
    let to = 'juan.castrosilva@oxxo.com';

    if (Numero_proveedor == "2086") {
      to = "Ivonne.Gonzalez@unilever.com, Magaly.Sanchez@unilever.com, Fabian.Becerra@unilever.com"
    }

    if (Numero_proveedor == "1940") {
      to = "aldeleon@sigma-alimentos.com, grmoran@sigma-alimentos.com"
    }

    let info = await transporter.sendMail({
      from: 'recibomercanciadirectos@oxxo.com',
      to: to,
      bcc: 'carlos.meza@oxxo.com, konia.cruz@oxxo.com, gloria.maldonado@serviciosexternos.com.mx, gerardo.vega@sygno.mx, gonzalo.aguilar@sygno.com.mx, gamaliel.segundo@sygno.mx, jose.cornelio@sygno.mx, juan.castrosilva@oxxo.com, eirud.juarez@serviciosexternos.com.mx, samely.herrera@sygno.mx, jose.antonio@sygno.com.mx',
      subject: `COMPROBANTE ENTREGA - (${current}) - ${Tienda}/${Cr_Tienda} - ${Numero_proveedor}/${Nombre_proveedor}`,
